...
import com.example.test.auth.AuthenticationActivity
...
class ProfileFragment : Fragment() {
        ...
        saveButton.setOnClickListener {
            ...
            userDocument.set(user).addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    Toast.makeText(context, "Something went again. Please try again.", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private fun addUserImage(){
        ...
        firestore.collection("Users")
            .document(UserUtils.user?.id!!).get()
