...
class CommentsAdapter(options: FirestoreRecyclerOptions<Comment>, val context: Context): FirestoreRecyclerAdapter<Comment, CommentsAdapter.CommentsViewHolder>(options) {
